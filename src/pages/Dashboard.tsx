...
export function Dashboard() {
  ...
  return (
    <div className="p-5">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Smart Filter Dashboard</h2>
      ...
      <button
        ...
        className="bg-gray-700 text-white px-4 py-2 rounded-md hover:bg-gray-800 transition mb-4"
      >
        Reset All Filters
      </button>
